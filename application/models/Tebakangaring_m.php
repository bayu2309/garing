...
class Tebakangaring_m extends CI_Model {
    ...
    function countQuestion(){
        $data['ques'] = $this->db->get('questions')
        $data['jumlah'] = count($data['ques']);
        return $data['jumlah'];
    }
...

    {
        ...
        ->where('answer1', $answer)->or_where('answer2',$answer)->or_where('answer3',$answer);
